...
void main() {
  ...
  setUp(() {
    settings =
        Settings(ColorMode.lightmode, Language.english, Language.english);
  });

  test('Einstellungen starten standardmäßig im Light Mode', () {
    expect(settings.colorMode, equals(ColorMode.lightmode));
  });

  test('Setze auf Dark Mode', () {
    settings.setDarkmode();

    expect(settings.colorMode, equals(ColorMode.darkmode));
  });
